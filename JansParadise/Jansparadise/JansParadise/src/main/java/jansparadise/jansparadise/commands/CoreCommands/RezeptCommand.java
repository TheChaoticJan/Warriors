...
public class RezeptCommand implements CommandExecutor, TabCompleter {
    ...
    public boolean onCommand(@NotNull CommandSender commandSender, @NotNull Command command, @NotNull String s, @NotNull String[] args) {
        if(commandSender instanceof Player p){
            ...
            switch (args[0]){
                case "Sci-Fi_Barren":
                    p.openInventory(SciFiRezeptInventare.Barren(p, null, SciFiBarren.SciFiBarren()));
                    break;
                case "Sci-Fi_Fragment":
                    p.openInventory(SciFiRezeptInventare.Fragment(p, null, SciFiFragment.SciFiFragment()));
                    break;
                case "Sci-Fi_Schwert":
                    p.openInventory(ErfahrenRezeptInventare.Fragment(p, null, Erfahrenfragment.SuperGold()));
                    break;
                case "Sci-Fi_Bogen":
                ...
                case "Erfahrenfragment":
                    ...
                    break;
                case "Erfahrenbarren":
                    p.openInventory(ErfahrenRezeptInventare.Barren(p, null, Erfahrenbarren.ErfahrenBarren()));
                    break;
                ...
                case "Erfahrenbogen":
                    ...
                    break;
                case "Explosivpuder":
                    p.openInventory(ExplosivRezeptInventare.Fragment(p, null, ExplosivPowder.Powder()));
                    break;
                case "Explosivbarren":
                    p.openInventory(ExplosivRezeptInventare.Barren(p, null, ExplosivKelp.DriedKelp()));
                    break;
                case "Explosivbohrer":
                ...
                case "Klebriger_Schleim":
                    p.openInventory(KlebrigRezeptInventare.Fragment(p, null, KlebrigSlime.Slime()));
                    break;
                case "Klebriger_Kristall":
                    p.openInventory(KlebrigRezeptInventare.Barren(p, null, KlebrigSuperSlime.Emerald()));
                    break;
