...
public class SpecialResources {
    ...
    public static ItemStack ErfahrenBarren(int amount){
        ItemStack SuperGoldBlock = new ItemStack(Material.GOLD_INGOT, amount);
    ...
    public static ItemStack ErfahrenFragment(int amount) {
        ItemStack SuperGold = new ItemStack(Material.GOLD_NUGGET, amount);
    ...
    public static ItemStack ExplosivBarren(int amount) {
        ItemStack SuperGold = new ItemStack(Material.DRIED_KELP, amount);
        ItemMeta SuperGoldMeta = SuperGold.getItemMeta();
    ...
    public static ItemStack ExplosivPuder(int amount) {
        ItemStack SuperGold = new ItemStack(Material.GUNPOWDER, amount);
        ItemMeta SuperGoldMeta = SuperGold.getItemMeta();
    ...
    public static ItemStack KlebrigFragment(int amount) {
        ItemStack SuperGold = new ItemStack(Material.SCUTE, amount);
        ItemMeta SuperGoldMeta = SuperGold.getItemMeta();
    ...
    public static ItemStack KlebrigBarren(int amount) {
        ItemStack SuperGold = new ItemStack(Material.EMERALD, amount);
        ItemMeta SuperGoldMeta = SuperGold.getItemMeta();
    ...
    public static ItemStack SciFiBarren(int amount){

        ItemStack SuperGoldBlock = new ItemStack(Material.DIAMOND, amount);
        ItemMeta SuperGoldBlockMeta = SuperGoldBlock.getItemMeta();
    ...
    public static ItemStack SciFiFragment(int amount){

        ItemStack SuperGoldBlock = new ItemStack(Material.AMETHYST_SHARD, amount);
        ItemMeta SuperGoldBlockMeta = SuperGoldBlock.getItemMeta();
